...
public class SolutionConverter {
	...
	public static void readSolutions(String inputFileName, int nbCrowns, int nbHexagons, String out) {
		...
		try {
			...
			while ((line = r.readLine()) != null) {
				...
				if (out == null)
					outputFileName = nbHexagons + "_hexagons" + i + ".graph";
				else
					outputFileName = out;
				
				@SuppressWarnings("unused")
				SolutionConverter converter = new SolutionConverter(line, nbCrowns, nbHexagons, diameter, outputFileName);
				i ++;
			}
	...
	public static void main(String [] args) {
		...
		readSolutions(inputFileName, nbCrowns, nbHexagons, outputFileName);
	}
